import torch
from torch.nn import ConvTranspose2d, Conv2d, ReLU, Tanh, LeakyReLU, Sequential, BatchNorm2d, MaxPool2d, Sigmoid
...
class Discriminator(torch.nn.Module):
    ...
    def __init__(self, input_channels=3):
        ...
        self.out = Sequential(
			...
			Conv2d(1024, 1, kernel_size=4, stride=1, padding=0, bias=False),
            Sigmoid()
...
class Generator(torch.nn.Module):
    ...
    def __init__(self, noise_dim, output_channels=3):
        ...
        self.hidden1 = Sequential(
			...
			ConvTranspose2d(1024, 512, kernel_size=4, stride=2, padding=1, bias=False),
            BatchNorm2d(512),
            ReLU(True)
        ...
        self.hidden3 = Sequential(
            # state size (256) x 16 x 16 
			ConvTranspose2d(256, 218, kernel_size=4, stride=2, padding=1, bias=False),
            BatchNorm2d(218),
            ReLU(True)
